...
public class Structures {
    ...
    public static class Parsed<T extends TypeDeclaration<T>> implements PrototypeDescription<T> {
        ...
        protected PrototypeDescription<T> parentParsed;
