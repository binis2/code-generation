...
public class BaseImpl implements Base {
    ...
    public String toString() {
        return "Base(baseTitle = " + baseTitle + ", baseList = " + CollectionUtils.printInfo(baseList, false) + ", baseSet = " + CollectionUtils.printInfo(baseSet, false) + ", baseMap = " + CollectionUtils.printInfo(baseMap, false) + ")";
    }
}
