...
import net.binis.codegen.objects.BaseCompiledWithExternalGenericImpl;
import net.binis.codegen.modifier.impl.BaseModifierImpl;
import net.binis.codegen.modifier.Modifiable;
import javax.annotation.processing.Generated;

@Generated(value = "net.binis.codegen.something.TestPrototype", comments = "Test")
public class TestImpl extends BaseCompiledWithExternalGenericImpl implements Test, Modifiable<Test.Modify> {
    ...
    protected class TestModifyImpl extends BaseModifierImpl<Test.Modify, Test> implements Test.Modify {
        ...
        public Test.Modify type(String type) {
